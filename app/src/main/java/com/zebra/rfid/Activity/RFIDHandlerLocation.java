...
class RFIDHandlerLocation implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private ScanLocationActivity context;
    ...
    void onCreate(ScanLocationActivity scanLocationActivity) {

        context = scanLocationActivity;
        // Status UI
        textView = scanLocationActivity.tvConnectionStatus;
        // SDK
        InitSDK();
    }
    ...
    synchronized boolean performInventoryStop() {
        // check reader connection
        if (!isReaderConnected())
            return false;
        try {
    ...
    public class EventHandler implements RfidEventsListener {
        ...
        public void eventStatusNotify(RfidStatusEvents rfidStatusEvents) {
            ...
            if (rfidStatusEvents.StatusEventData.getStatusEventType() == STATUS_EVENT_TYPE.HANDHELD_TRIGGER_EVENT) {   //--HANDHELD_TRIGGER_EVENT
